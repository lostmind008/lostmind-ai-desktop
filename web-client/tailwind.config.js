...
module.exports = {
  ...
  plugins: [
    ...
    // Custom plugin for chat bubble styles
    function({ addComponents }) {
      addComponents({
        ...
        '.chat-bubble-system': {
          '@apply bg-warning-100 text-warning-800 mx-auto text-center text-sm': {},
        },
        '.thinking-indicator': {
          '@apply flex items-center space-x-1 text-secondary-500': {},
        },
        '.typing-dots': {
